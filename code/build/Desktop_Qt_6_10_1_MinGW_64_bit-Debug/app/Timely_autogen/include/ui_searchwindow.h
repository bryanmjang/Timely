...
public:
    ...
    void setupUi(QDialog *SearchWindow)
    {
        ...
        widget->setGeometry(QRect(0, 20, 321, 127));
        verticalLayout = new QVBoxLayout(widget);
        verticalLayout->setSpacing(3);
        verticalLayout->setObjectName("verticalLayout");
        verticalLayout->setContentsMargins(0, 0, 0, 0);
        byAll = new QPushButton(widget);
        ...
        byTitle = new QPushButton(widget);
        ...
        widget2 = new QWidget(byTitlePage);
        widget2->setObjectName("widget2");
        widget2->setGeometry(QRect(10, 30, 311, 30));
        formLayout_2 = new QFormLayout(widget2);
        formLayout_2->setObjectName("formLayout_2");
        formLayout_2->setContentsMargins(0, 0, 0, 0);
        titleLabel = new QLabel(widget2);
